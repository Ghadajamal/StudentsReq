...
if (isset($_GET['id'])) {
  ...
  $id = $_GET['id'];
  $id1 = $_GET['id'];
  $sql = mysqli_query($con, "SELECT * FROM demandeconv WHERE id='$id' ");
...
$temp_pdf_file = tempnam(sys_get_temp_dir(), 'convention_');
file_put_contents($temp_pdf_file, $pdf_content);

// Attach the PDF file to the email
$mail->AddAttachment($temp_pdf_file, 'convention.pdf');
