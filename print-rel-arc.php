...
$sql = mysqli_query($con, "SELECT * FROM Notes INNER JOIN archive_rel ON Notes.apogee = archive_rel.apogee INNER JOIN Module ON Notes.ID_module=Module.ID_module where archive_rel.apogee='$id'");
...
$dompdf->render();
$dompdf->stream('releve.pdf', ['Attachement'=>false]);
?>
